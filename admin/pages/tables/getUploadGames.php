        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Upload Games</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Games Detail</h3>
                 <a class="btn btn-info" href="../forms/gameUpload.php" style="float:right;">Add New</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    if(($count) > 0){
                      foreach($result as $key=> $val) {?>
                        ...
                        <tr>
                          <td><img src="../upload/<?php echo $val['image']; ?>" height="100px" width="150px"></td>
                          ...
                          <td style="width: 20px;"><a id="<?php echo $val['id']; ?>" class="iconbox delete"><i class="fa fa-times" aria-hidden="true"></i></a>
                            <a href="../forms/edit_game.php?id=<?php echo $val['id']; ?>" class="iconbox"><i class="fa fa-pen" aria-hidden="true"></i></a>
                          </td>
                        </tr>
...
var deleteid = $(this).attr('id');
   ...
   if (confirmalert == true) {
      ...
      $.ajax({
        ...
        data: { id:deleteid, action:'delete_game' },
